...
import com.example.chart.MainChart
...
class profile : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val button_cycle = view.findViewById(R.id.cycle_view) as Button
        val chart_button = view.findViewById(R.id.chart_button) as Button
        ...
        button_cycle.setOnClickListener {
            val fragment_RecyclerView = RecycleView()
        ...
        chart_button.setOnClickListener {
            val Main_Chart = MainChart()
            val fm = fragmentManager
            val transaction : FragmentTransaction = fm!!.beginTransaction()
            transaction.replace(R.id.contentContainer, Main_Chart,"fragment_MainChart")
